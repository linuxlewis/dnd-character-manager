			...
			{ABILITY_KEYS.map((key, i) => (
				<Tooltip key={key}>
					<TooltipTrigger asChild>
						<div
							className="relative flex flex-col items-center p-3 rounded-lg border-2 border-border bg-card transition-all hover:border-primary/50 hover:shadow-md animate-fade-in"
