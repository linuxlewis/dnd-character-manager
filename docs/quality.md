...
| inventory | A | N/A | A | N/A | N/A | N/A | B | A1 inventory types provide boundary-safe Zod schemas, currency conversion helpers, ownership/item invariants, and 27 focused unit tests; A2 adds character scope/treasury mappings, parsed row mappers, race-safe transactional persistence, and focused unit/integration coverage; Config/Service/Runtime/UI remain unimplemented |
